...
1. un'imposta di tipo vendite con importo 0. Ad esempio "Non imponibile
...
2. una posizione fiscale per le dichiarazioni d'intento, avente:
   ...
   -  una mappatura delle imposte opportuna. Ad esempio tra "IVA al 22%
      (debito) (Vendita)" e "Non imponibile art.8c Lettera intento".
